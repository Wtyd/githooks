...
| [PHP CodeSniffer](phpcs.md) | `phpcs` | Yes | `--parallel` flag |
| [PHP Code Beautifier](phpcs.md) | `phpcbf` | Yes | `--parallel` flag |
| [PHP Mess Detector](phpmd.md) | `phpmd` | Yes | No |
| [PHPUnit](phpunit.md) | `phpunit` | No | No |
| [Paratest](paratest.md) | `paratest` | No | `--processes` flag |
| [Pest](pest.md) | `pest` | No | `--parallel --processes` flags |
...
| [Laravel Pint](pint.md) | `pint` | Yes | No |
